// Ler da ADC com interrupções e meter no display o valor lido em hexadecimal
// Frequência da ADC de 10Hz
// Frêquencia de refrescamento do display 100Hz através do timer 2
